          ...
          <v-stepper v-model="e6" vertical>
            ...
            <v-stepper-content step="2">
              ...
              <v-text-field
                ...
                outlined
                required
                v-model="shs_registration.lastname"
              ></v-text-field>
              <v-text-field
                label="Middle Name"
                outlined
                required
                v-model="shs_registration.middlename"
              ></v-text-field>
              ...
              <v-text-field
                ...
                outlined
                required
                v-model="shs_registration.guardian"
              ></v-text-field>
              <v-dialog
                ref="dialog"
                v-model="modal"
              ...
              >
                ...
                >
                  ...
                  <v-btn
                    text
                    color="primary"
                    @click="$refs.dialog.save(shs_registration.DateOfBirth)"
                    >OK</v-btn
                  >
                </v-date-picker>
              </v-dialog>
              ...
              <v-text-field
                ...
                outlined
                required
                v-model="shs_registration.prevSchool"
              ></v-text-field>
              <v-text-field
                label="Section"
                outlined
                required
                v-model="shs_registration.section"
              ></v-text-field>
              <v-text-field
                label="School year"
                outlined
                required
                v-model="shs_registration.sy"
              ></v-text-field>
            ...
            <v-stepper-content step="3">
              <v-text-field
                ...
                outlined
                required
                v-model="shs_registration.address"
              ></v-text-field>
              <v-text-field
              ...
              <v-text-field
                ...
                outlined
                required
                v-model="shs_registration.city"
              ></v-text-field>
              <v-text-field
                label="Province"
                outlined
                required
                v-model="shs_registration.province"
              ></v-text-field>
              <v-text-field
                label="Postal Code"
                outlined
                required
                v-model="shs_registration.postal_code"
              ></v-text-field>
            ...
            <v-stepper-content step="4">
              <v-text-field
                ...
                outlined
                v-model="shs_registration.contact_number"
              ></v-text-field>
              <v-text-field
                label="Email Address"
                outlined
